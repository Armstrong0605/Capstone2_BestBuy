...
public class Utilityclass {
	...
	public static void readFromPropFile() throws Exception {
		...
		FileReader file = new FileReader("C:\\Users\\Jenner\\eclipse-workspace\\E-Commerce_Bestbuy\\src\\main\\resources\\Credential\\Browser.properties");
	...
	public String screenShot(String name) throws IOException {
		...
		String path ="C:\\Users\\Jenner\\eclipse-workspace\\E-Commerce_Bestbuy\\Screenshot"+name+".png";
	...
	public static String[][] readExcel(String sheetname) throws Exception {
		...
		XSSFWorkbook book = new XSSFWorkbook("C:\\Users\\Jenner\\eclipse-workspace\\E-Commerce_Bestbuy\\src\\test\\resources\\E-commerce data.xlsx");
